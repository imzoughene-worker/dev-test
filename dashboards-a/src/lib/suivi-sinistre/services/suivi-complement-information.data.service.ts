...
@Injectable()
export class SuiviComplementInformationService extends ListingFetchService {
  ...
  public fetchGrid(filter: ISuiviLotFilters): Observable<any> {
    ...
    return super.fetchPOST(false, "api/1.0/Dashboard/SuiviSinistre/GetSuiviComplementInformations", this.baseUrl, manualFilter, this.state)
      .pipe(
        tap((result) => {
