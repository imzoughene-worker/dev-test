...
@Injectable()
export class RejetsService extends ListingFetchService {
  ...
  public fetchGrid(filter: ISuiviLotFilters): Observable<any> {
    this.isLoading = true;
    return super.fetchPOST(false, 'api/1.0/Dashboard/SuiviSinistre/GetRejets', this.baseUrl, { ...filter, etatClients: [] }, this.state, 1000)
      .pipe(
