...
import { ISuiviArrivageLotFilters } from '@portals/client-reporting';
import { UntypedFormBuilder, UntypedFormGroup } from '@angular/forms';
import dayjs from 'dayjs';
import { EnvironmentService } from '@portals/base/core/core-component';

@Injectable()
export class SuiviArrivageService {
  suiviArrivageFilters$: BehaviorSubject<ISuiviArrivageLotFilters | null> =
    new BehaviorSubject<ISuiviArrivageLotFilters | null>(null);
  ...
  filterByPolice: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
  today = dayjs().toDate();
