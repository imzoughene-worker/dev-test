...
@Injectable()
export class PecAvecRetourCieService extends ListingFetchService {
  ...
  public fetchGrid(filter: ISuiviLotFilters): Observable<any> {
    this.isLoading = true;
    return this.fetchPOST(false, 'api/1.0/Dashboard/SuiviSinistre/GetSuiviPECAvecRetourCie', this.baseUrl, { ...filter, etatClients: [] }, this.state, 1000)
      .pipe(
